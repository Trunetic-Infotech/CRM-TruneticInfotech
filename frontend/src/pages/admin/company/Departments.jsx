  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex justify-between ">
        <div>
          {" "}
          <p className="font-bold text-3xl pl-7 md:pl-0">Departments</p>
        ...
        <div>
          ...
          <AddButton data="Add Department" onclick={() => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 place-items-center">
        <Card label="Total Departments" data="6" icon={totalDepartmentIcon} />
        <Card label="Active Departments" data="5" icon={activeDepartmentIcon} />
